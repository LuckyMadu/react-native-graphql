...
<table>
  ...
  <tr>
    <td>
      * Persist data when you are logging into the application if there is no internet connection, \\ Here I have used AsyncStorage to save the latest movie list and fetch them if there is no internet connection.
